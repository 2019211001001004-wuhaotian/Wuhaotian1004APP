...
namespace CMSWinFormsApp {
    ...
    public partial class CMSDBDataSet : global::System.Data.DataSet {
        ...
        public partial class tblJobDetailsDataTable : global::System.Data.TypedTableBase<tblJobDetailsRow> {
            ...
            private global::System.Data.DataColumn columnGerOilQty;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public global::System.Data.DataColumn GerOilQtyColumn {
                get {
                    return this.columnGerOilQty;
                }
            }
            ...
            internal void InitVars() {
                ...
                this.columnGerOilQty = base.Columns["GerOilQty"];
            ...
            private void InitClass() {
                ...
                this.columnGerOilQty = new global::System.Data.DataColumn("GerOilQty", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnGerOilQty);
        ...
        public partial class tblJobDetailsRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public int GerOilQty {
                get {
                    try {
                        return ((int)(this[this.tabletblJobDetails.GerOilQtyColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("表“tblJobDetails”中列“GerOilQty”的值为 DBNull。", e);
                    }
                }
                set {
                    this[this.tabletblJobDetails.GerOilQtyColumn] = value;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IsGerOilQtyNull() {
                return this.IsNull(this.tabletblJobDetails.GerOilQtyColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetGerOilQtyNull() {
                this[this.tabletblJobDetails.GerOilQtyColumn] = global::System.Convert.DBNull;
            }
...
SELECT CarNo, Name, Address, Make FROM tblCustomer WHERE (CarNo = @CarNo)";
    ...
    public partial class tblJobDetailsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("GerOilQty", "GerOilQty");
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tblJobDetails] ([CarNo], [JobDate], [WorkerID], [KMS], [Tunning], [Alignment], [Balancing], [Tires], [Weights], [OilChanged], [OilQty], [OilFilter], [GearOil], [GerOilQty], [Point], [Condenser], [Plug], [PlugQty], [FuelFilter], [AirFilter], [Remarks]) VALUES (@CarNo, @JobDate, @WorkerID, @KMS, @Tunning, @Alignment, @Balancing, @Tires, @Weights, @OilChanged, @OilQty, @OilFilter, @GearOil, @GerOilQty, @Point, @Condenser, @Plug, @PlugQty, @FuelFilter, @AirFilter, @Remarks)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CarNo", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CarNo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@GerOilQty", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "GerOilQty", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CarNo, JobDate, WorkerID, KMS, Tunning, Alignment, Balancing, Tires, Weigh" +
                "ts, OilChanged, OilQty, OilFilter, GearOil, GerOilQty, Point, Condenser, Plug, P" +
        ...
        public virtual int Insert(
                    ...
                    global::System.Nullable<int> GerOilQty, 
            ...
            if ((GerOilQty.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[13].Value = ((int)(GerOilQty.Value));
            }
            else {
